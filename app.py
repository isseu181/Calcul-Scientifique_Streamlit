...
# Module 1 : Calcul d'intégrale (conservé tel quel)
elif st.session_state.current_page == "Calcul d’intégrale":
...
# Module 2 : Interpolation (conservé tel quel)
elif st.session_state.current_page == "Interpolation":
...
# Module 3 : Analyse de fonction de transfert (conservé tel quel)
elif st.session_state.current_page == "Analyse de fonction de transfert":
...
# Module 4 : Équations différentielles (conservé tel quel)
elif st.session_state.current_page == "Équations différentielles":
...
# Module 5 : Intégration numérique (conservé tel quel)
elif st.session_state.current_page == "Intégration numérique":
...
# Module 6 : Systèmes linéaires (conservé tel quel)
elif st.session_state.current_page == "Systèmes linéaires":
...
# Module 7 : Décomposition LU (conservé tel quel)
elif st.session_state.current_page == "Décomposition LU":
...
# Module 8 : Applications Laser (conservé tel quel)
...
# Module 9 : Optimisation linéaire (conservé tel quel)
elif st.session_state.current_page == "Optimisation linéaire":
...
# Module 10 : Séries de Fourier (conservé tel quel)
elif st.session_state.current_page == "Séries de Fourier":
